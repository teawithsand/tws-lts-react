 ...
 * 
 * And that useMemo must be called from outside of the component, because throwing in component(which is what suspense does)
 * causes all hooks to be reset/makes them not work.
 */
